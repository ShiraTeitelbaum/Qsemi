...
app.returnWireLaying12 = kendo.observable({
    onShow: function() {},
    afterShow: function() {}
});
app.localization.registerView('returnWireLaying12');

// START_CUSTOM_CODE_returnWireLaying12
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_returnWireLaying12
(function(parent) {
    var dataProvider = app.data.qcsemidataProvider,
        ...
        fetchFilteredData = function(paramFilter, searchFilter) {
            var model = parent.get('returnWireLaying12Model'),
                dataSource;

            if (model) {
                dataSource = model.get('dataSource');
            } else {
                parent.set('returnWireLaying12Model_delayedFetch', paramFilter || null);
                return;
            }
        ...
        /// start data sources
        /// end data sources
        returnWireLaying12Model = kendo.observable({
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || returnWireLaying12Model.originalItem;

                app.mobileApp.navigate('#components/returnWireLaying12/details.html?uid=' + dataItem.uid);

            },
            editClick: function() {
                var uid = this.originalItem.uid;
                app.mobileApp.navigate('#components/returnWireLaying12/edit.html?uid=' + uid);
            },
            detailsShow: function(e) {
                var uid = e.view.params.uid,
                    dataSource = returnWireLaying12Model.get('dataSource'),
                    itemModel = dataSource.getByUid(uid);

                returnWireLaying12Model.setCurrentItemByUid(uid);
            ...
            setCurrentItemByUid: function(uid) {
                ...
                returnWireLaying12Model.set('originalItem', itemModel);
                returnWireLaying12Model.set('currentItem',
                    returnWireLaying12Model.fixHierarchicalData(itemModel));
    ...
    parent.set('editItemViewModel', kendo.observable({
        ...
        onShow: function(e) {
            ...
            var that = this,
                ...
                //fixedData = returnWireLaying12Model.fixHierarchicalData(itemData);

                app.mobileApp.showLoading();
            /// start edit form before itemData
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                var jsdoOptions2 = returnWireLaying12Model.get('_jsdoOptions'),
                ...
                dataSource2.filter({ field: "R363890851", operator: "==", value: element_id });
                ...
                dataSource2.fetch(function() {
                    ...
                    fixedData = returnWireLaying12Model.fixHierarchicalData(itemData);
                     ...
                     var checkBox1List = app.returnWireLaying12.returnWireLaying12Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox1().response.picklistData;
                     var checkBox2List = app.returnWireLaying12.returnWireLaying12Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox2().response.picklistData;
                     var checkBox3List = app.returnWireLaying12.returnWireLaying12Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox3().response.picklistData;
                     var checkBox4List = app.returnWireLaying12.returnWireLaying12Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox4().response.picklistData;
                     var checkBox5List = app.returnWireLaying12.returnWireLaying12Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox5().response.picklistData;
                     ...
                     if(itemData.Checkbox2 != "null") {
                        for(var i=0; i<checkBox2List.length; i++) {
                            if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "OK") {
                                $("#checkbox2RWL1").attr("checked", true);
                            }
                            else if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "Not OK") {
                                $("#checkbox2NotOkRWL1").attr("checked", true);
                                $("#comments2FieldRWL1").show();
                            }
                        }
                     }
                     if(itemData.Checkbox3 != "null") {
                        for(var i=0; i<checkBox3List.length; i++) {
                            if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "OK") {
                                $("#checkbox3RWL1").attr("checked", true);
                            }
                            else if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "Not OK") {
                                $("#checkbox3NotOkRWL1").attr("checked", true);
                                $("#comments3FieldRWL1").show();
                            }
                        }
                     }
                     if(itemData.Checkbox4 != "null") {
                        for(var i=0; i<checkBox4List.length; i++) {
                            if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "OK") {
                                $("#checkbox4RWL1").attr("checked", true);
                            }
                            else if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "Not OK") {
                                $("#checkbox4NotOkRWL1").attr("checked", true);
                                $("#comments4FieldRWL1").show();
                            }
                        }
                     }
                     if(itemData.Checkbox5 != "null") {
                        for(var i=0; i<checkBox5List.length; i++) {
                            if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "OK") {
                                $("#checkbox5RWL1").attr("checked", true);
                            }
                            else if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "Not OK") {
                                $("#checkbox5NotOkRWL1").attr("checked", true);
                                $("#comments5FieldRWL1").show();
                            }
                        }
                     }

                     if(itemData.Completed == true) {
                         $("#completedRWL1").attr("checked", true);
                     }
            ...
            this.set('editFormData', {
                ...
                textAreaField: itemData.Checkbox1,
            ...
            $("#comments1FieldRWL1").hide();
            $("#comments2FieldRWL1").hide();
            $("#comments3FieldRWL1").hide();
            $("#comments4FieldRWL1").hide();
            $("#comments5FieldRWL1").hide();
            /// end edit form show
        },
        linkBind: function(linkString) {
            var linkChunks = linkString.split(':');
        ...
        onSaveClick: function(e) {
            var that = this,
                ...
                dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                    ...
                    dataSource2.fetch(function() {
                        ...
                        itemData.set('signature', $("#signatureRWL1").jSignature("getData"));
            ...
            itemData.set('Comments2', editFormData.comments2);
            itemData.set('Comments1', editFormData.comments1);
            itemData.set('Checkbox1', editFormData.textAreaField);
    ...
    if (typeof dataProvider.sbProviderReady === 'function') {
        dataProvider.sbProviderReady(function dl_sbProviderReady() {
            parent.set('returnWireLaying12Model', returnWireLaying12Model);
            var param = parent.get('returnWireLaying12Model_delayedFetch');
            if (typeof param !== 'undefined') {
                parent.set('returnWireLaying12Model_delayedFetch', undefined);
    ...
    parent.set('onShow', function(e) {
        var param = e.view.params.filter ? JSON.parse(e.view.params.filter) : null,
            ...
            dataSourceOptions = returnWireLaying12Model.get('_dataSourceOptions'),
            dataSource;
        ...
        if (!returnWireLaying12Model.get('dataSource')) {
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                var jsdoOptions = returnWireLaying12Model.get('_jsdoOptions'),
                    jsdo = new progress.data.JSDO(jsdoOptions);

                dataSourceOptions.transport.jsdo = jsdo;
                dataSource = new kendo.data.DataSource(dataSourceOptions);
                returnWireLaying12Model.set('dataSource', dataSource);
...
})(app.returnWireLaying12);

// START_CUSTOM_CODE_returnWireLaying12Model
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// you can handle the beforeFill / afterFill events here. For example:
/*
app.returnWireLaying12.returnWireLaying12Model.get('_jsdoOptions').events = {
    'beforeFill' : [ {
        scope : app.returnWireLaying12.returnWireLaying12Model,
...
*/
// END_CUSTOM_CODE_returnWireLaying12Model