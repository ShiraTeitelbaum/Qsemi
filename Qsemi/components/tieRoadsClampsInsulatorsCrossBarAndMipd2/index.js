...
app.tieRoadsClampsInsulatorsCrossBarAndMipd2 = kendo.observable({
    onShow: function() {},
    afterShow: function() {}
});
app.localization.registerView('tieRoadsClampsInsulatorsCrossBarAndMipd2');

// START_CUSTOM_CODE_tieRoadsClampsInsulatorsCrossBarAndMipd2
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_tieRoadsClampsInsulatorsCrossBarAndMipd2
(function(parent) {
    var dataProvider = app.data.qcsemidataProvider,
        ...
        fetchFilteredData = function(paramFilter, searchFilter) {
            var model = parent.get('tieRoadsClampsInsulatorsCrossBarAndMipd2Model'),
                dataSource;

            if (model) {
                dataSource = model.get('dataSource');
            } else {
                parent.set('tieRoadsClampsInsulatorsCrossBarAndMipd2Model_delayedFetch', paramFilter || null);
                return;
            }
        ...
        jsdoOptions = {
            name: 'Tie_Rods__Clamps__Insulators__Cross_Bars',
            autoFill: false
        },
        dataSourceOptions = {
            type: 'jsdo',
        ...
        /// start data sources
        /// end data sources
        tieRoadsClampsInsulatorsCrossBarAndMipd2Model = kendo.observable({
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || tieRoadsClampsInsulatorsCrossBarAndMipd2Model.originalItem;

                app.mobileApp.navigate('#components/tieRoadsClampsInsulatorsCrossBarAndMipd2/details.html?uid=' + dataItem.uid);

            },
            editClick: function() {
                var uid = this.originalItem.uid;
                app.mobileApp.navigate('#components/tieRoadsClampsInsulatorsCrossBarAndMipd2/edit.html?uid=' + uid);
            },
            detailsShow: function(e) {
                var uid = e.view.params.uid,
                    dataSource = tieRoadsClampsInsulatorsCrossBarAndMipd2Model.get('dataSource'),
                    itemModel = dataSource.getByUid(uid);

                tieRoadsClampsInsulatorsCrossBarAndMipd2Model.setCurrentItemByUid(uid);
            ...
            setCurrentItemByUid: function(uid) {
                ...
                tieRoadsClampsInsulatorsCrossBarAndMipd2Model.set('originalItem', itemModel);
                tieRoadsClampsInsulatorsCrossBarAndMipd2Model.set('currentItem',
                    tieRoadsClampsInsulatorsCrossBarAndMipd2Model.fixHierarchicalData(itemModel));
    ...
    parent.set('editItemViewModel', kendo.observable({
        ...
        onShow: function(e) {
            ...
            var that = this,
                ...
                //fixedData = tieRoadsClampsInsulatorsCrossBarAndMipd2Model.fixHierarchicalData(itemData);

                 app.mobileApp.showLoading();
            /// start edit form before itemData
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                var jsdoOptions2 = tieRoadsClampsInsulatorsCrossBarAndMipd2Model.get('_jsdoOptions'),
                ...
                dataSource2.filter({ field: "R363890869", operator: "==", value: element_id });
                ...
                dataSource2.fetch(function() {
                    ...
                    fixedData = tieRoadsClampsInsulatorsCrossBarAndMipd2Model.fixHierarchicalData(itemData);
                     ...
                     var checkBox1List = app.tieRoadsClampsInsulatorsCrossBarAndMipd2.tieRoadsClampsInsulatorsCrossBarAndMipd2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox1().response.picklistData;
                     var checkBox2List = app.tieRoadsClampsInsulatorsCrossBarAndMipd2.tieRoadsClampsInsulatorsCrossBarAndMipd2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox2().response.picklistData;
                     var checkBox3List = app.tieRoadsClampsInsulatorsCrossBarAndMipd2.tieRoadsClampsInsulatorsCrossBarAndMipd2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox3().response.picklistData;
                     var checkBox4List = app.tieRoadsClampsInsulatorsCrossBarAndMipd2.tieRoadsClampsInsulatorsCrossBarAndMipd2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox4().response.picklistData;
                     var checkBox5List = app.tieRoadsClampsInsulatorsCrossBarAndMipd2.tieRoadsClampsInsulatorsCrossBarAndMipd2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox5().response.picklistData;
                     ...
                     if(itemData.Checkbox1 != "null") {
                        for(var i=0; i<checkBox1List.length; i++) {
                            if(itemData.Checkbox1 == checkBox1List[i].id && checkBox1List[i].name == "OK") {
                                $("#checkbox1TRCIC").attr("checked", true);
                            }
                            else if(itemData.Checkbox1 == checkBox1List[i].id && checkBox1List[i].name == "Not OK") {
                                $("#checkbox1NotOkTRCIC").attr("checked", true);
                                $("#comments1FieldTRCIC").show();
                            }
                        }
                     }
                     if(itemData.Checkbox2 != "null") {
                        for(var i=0; i<checkBox2List.length; i++) {
                            if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "OK") {
                                $("#checkbox2TRCIC").attr("checked", true);
                            }
                            else if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "Not OK") {
                                $("#checkbox2NotOkTRCIC").attr("checked", true);
                                $("#comments2FieldTRCIC").show();
                            }
                        }
                     }
                     if(itemData.Checkbox3 != "null") {
                        for(var i=0; i<checkBox3List.length; i++) {
                            if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "OK") {
                                $("#checkbox3TRCIC").attr("checked", true);
                            }
                            else if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "Not OK") {
                                $("#checkbox3NotOkTRCIC").attr("checked", true);
                                $("#comments3FieldTRCIC").show();
                            }
                        }
                     }
                     if(itemData.Checkbox4 != "null") {
                        for(var i=0; i<checkBox4List.length; i++) {
                            if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "OK") {
                                $("#checkbox4TRCIC").attr("checked", true);
                            }
                            else if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "Not OK") {
                                $("#checkbox4NotOkTRCIC").attr("checked", true);
                                $("#comments4FieldTRCIC").show();
                            }
                        }
                     }
                     if(itemData.Checkbox5 != "null") {
                        for(var i=0; i<checkBox5List.length; i++) {
                            if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "OK") {
                                $("#checkbox5TRCIC").attr("checked", true);
                            }
                            else if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "Not OK") {
                                $("#checkbox5NotOkTRCIC").attr("checked", true);
                                $("#comments5FieldTRCIC").show();
                            }
                        }
                     }

                     if(itemData.Completed == true) {
                         $("#completedTRCIC").attr("checked", true);
                     }
            ...
            $("#comments1FieldTRCIC").hide();
            $("#comments2FieldTRCIC").hide();
            $("#comments3FieldTRCIC").hide();
            $("#comments4FieldTRCIC").hide();
            $("#comments5FieldTRCIC").hide();
            /// end edit form show
        },
        linkBind: function(linkString) {
            var linkChunks = linkString.split(':');
            ...
            var that = this,
                ...
                dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                    ...
                    dataSource2.fetch(function() {
                        ...
                        itemData.set('signature', $("#signatureTRCIC").jSignature("getData"));
    ...
    if (typeof dataProvider.sbProviderReady === 'function') {
        dataProvider.sbProviderReady(function dl_sbProviderReady() {
            parent.set('tieRoadsClampsInsulatorsCrossBarAndMipd2Model', tieRoadsClampsInsulatorsCrossBarAndMipd2Model);
            var param = parent.get('tieRoadsClampsInsulatorsCrossBarAndMipd2Model_delayedFetch');
            if (typeof param !== 'undefined') {
                parent.set('tieRoadsClampsInsulatorsCrossBarAndMipd2Model_delayedFetch', undefined);
    ...
    parent.set('onShow', function(e) {
        var param = e.view.params.filter ? JSON.parse(e.view.params.filter) : null,
            ...
            dataSourceOptions = tieRoadsClampsInsulatorsCrossBarAndMipd2Model.get('_dataSourceOptions'),
            dataSource;
        ...
        if (!tieRoadsClampsInsulatorsCrossBarAndMipd2Model.get('dataSource')) {
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                var jsdoOptions = tieRoadsClampsInsulatorsCrossBarAndMipd2Model.get('_jsdoOptions'),
                    jsdo = new progress.data.JSDO(jsdoOptions);

                dataSourceOptions.transport.jsdo = jsdo;
                dataSource = new kendo.data.DataSource(dataSourceOptions);
                tieRoadsClampsInsulatorsCrossBarAndMipd2Model.set('dataSource', dataSource);
...
})(app.tieRoadsClampsInsulatorsCrossBarAndMipd2);

// START_CUSTOM_CODE_tieRoadsClampsInsulatorsCrossBarAndMipd2Model
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// you can handle the beforeFill / afterFill events here. For example:
/*
app.tieRoadsClampsInsulatorsCrossBarAndMipd2.tieRoadsClampsInsulatorsCrossBarAndMipd2Model.get('_jsdoOptions').events = {
    'beforeFill' : [ {
        scope : app.tieRoadsClampsInsulatorsCrossBarAndMipd2.tieRoadsClampsInsulatorsCrossBarAndMipd2Model,
...
*/
// END_CUSTOM_CODE_tieRoadsClampsInsulatorsCrossBarAndMipd2Model