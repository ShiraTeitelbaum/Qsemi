...
app.returnWire2AndSupportAndConnection2 = kendo.observable({
    onShow: function() {},
    afterShow: function() {}
});
app.localization.registerView('returnWire2AndSupportAndConnection2');

// START_CUSTOM_CODE_returnWire2AndSupportAndConnection2
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_returnWire2AndSupportAndConnection2
(function(parent) {
    var dataProvider = app.data.qcsemidataProvider,
        ...
        fetchFilteredData = function(paramFilter, searchFilter) {
            var model = parent.get('returnWire2AndSupportAndConnection2Model'),
                dataSource;

            if (model) {
                dataSource = model.get('dataSource');
            } else {
                parent.set('returnWire2AndSupportAndConnection2Model_delayedFetch', paramFilter || null);
                return;
            }
        ...
        jsdoOptions = {
            name: 'RETURN_WIRE_2__SUPPORT_connection',
            autoFill: false
        },
        dataSourceOptions = {
            type: 'jsdo',
        ...
        /// start data sources
        /// end data sources
        returnWire2AndSupportAndConnection2Model = kendo.observable({
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || returnWire2AndSupportAndConnection2Model.originalItem;

                app.mobileApp.navigate('#components/returnWire2AndSupportAndConnection2/details.html?uid=' + dataItem.uid);

            },
            editClick: function() {
                var uid = this.originalItem.uid;
                app.mobileApp.navigate('#components/returnWire2AndSupportAndConnection2/edit.html?uid=' + uid);
            },
            detailsShow: function(e) {
                var uid = e.view.params.uid,
                    dataSource = returnWire2AndSupportAndConnection2Model.get('dataSource'),
                    itemModel = dataSource.getByUid(uid);

                returnWire2AndSupportAndConnection2Model.setCurrentItemByUid(uid);
            ...
            setCurrentItemByUid: function(uid) {
                ...
                returnWire2AndSupportAndConnection2Model.set('originalItem', itemModel);
                returnWire2AndSupportAndConnection2Model.set('currentItem',
                    returnWire2AndSupportAndConnection2Model.fixHierarchicalData(itemModel));
    ...
    parent.set('editItemViewModel', kendo.observable({
        ...
        onShow: function(e) {
            ...
            var that = this,
                ...
                //fixedData = returnWire2AndSupportAndConnection2Model.fixHierarchicalData(itemData);

                app.mobileApp.showLoading();
            /// start edit form before itemData
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                var jsdoOptions2 = returnWire2AndSupportAndConnection2Model.get('_jsdoOptions'),
                ...
                dataSource2.filter({ field: "R363890830", operator: "==", value: element_id });
                ...
                dataSource2.fetch(function() {
                    ...
                    fixedData = returnWire2AndSupportAndConnection2Model.fixHierarchicalData(itemData);
                     ...
                     var checkBox1List = app.returnWire2AndSupportAndConnection2.returnWire2AndSupportAndConnection2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox1().response.picklistData;
                     var checkBox2List = app.returnWire2AndSupportAndConnection2.returnWire2AndSupportAndConnection2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox2().response.picklistData;
                     var checkBox3List = app.returnWire2AndSupportAndConnection2.returnWire2AndSupportAndConnection2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox3().response.picklistData;
                     var checkBox4List = app.returnWire2AndSupportAndConnection2.returnWire2AndSupportAndConnection2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox4().response.picklistData;
                     var checkBox5List = app.returnWire2AndSupportAndConnection2.returnWire2AndSupportAndConnection2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox5().response.picklistData;
                     ...
                     if(itemData.Checkbox1 != "null") {
                        for(var i=0; i<checkBox1List.length; i++) {
                            if(itemData.Checkbox1 == checkBox1List[i].id && checkBox1List[i].name == "OK") {
                                $("#checkbox1RWSC").attr("checked", true);
                            }
                            else if(itemData.Checkbox1 == checkBox1List[i].id && checkBox1List[i].name == "Not OK") {
                                $("#checkbox1NotOkRWSC").attr("checked", true);
                                $("#comments1FieldRWSC").show();
                            }
                        }
                     }
                     if(itemData.Checkbox2 != "null") {
                        for(var i=0; i<checkBox2List.length; i++) {
                            if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "OK") {
                                $("#checkbox2RWSC").attr("checked", true);
                            }
                            else if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "Not OK") {
                                $("#checkbox2NotOkRWSC").attr("checked", true);
                                $("#comments2FieldRWSC").show();
                            }
                        }
                     }
                     if(itemData.Checkbox3 != "null") {
                        for(var i=0; i<checkBox3List.length; i++) {
                            if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "OK") {
                                $("#checkbox3RWSC").attr("checked", true);
                            }
                            else if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "Not OK") {
                                $("#checkbox3NotOkRWSC").attr("checked", true);
                                $("#comments3FieldRWSC").show();
                            }
                        }
                     }
                     if(itemData.Checkbox4 != "null") {
                        for(var i=0; i<checkBox4List.length; i++) {
                            if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "OK") {
                                $("#checkbox4RWSC").attr("checked", true);
                            }
                            else if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "Not OK") {
                                $("#checkbox4NotOkRWSC").attr("checked", true);
                                $("#comments4FieldRWSC").show();
                            }
                        }
                     }
                     if(itemData.Checkbox5 != "null") {
                        for(var i=0; i<checkBox5List.length; i++) {
                            if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "OK") {
                                $("#checkbox5RWSC").attr("checked", true);
                            }
                            else if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "Not OK") {
                                $("#checkbox5NotOkRWSC").attr("checked", true);
                                $("#comments5FieldRWSC").show();
                            }
                        }
                     }

                     if(itemData.Completed == true) {
                         $("#completedRWSC").attr("checked", true);
                     }
            ...
            $("#comments1FieldRWSC").hide();
            $("#comments2FieldRWSC").hide();
            $("#comments3FieldRWSC").hide();
            $("#comments4FieldRWSC").hide();
            $("#comments5FieldRWSC").hide();
            /// end edit form show
        },
        linkBind: function(linkString) {
            var linkChunks = linkString.split(':');
            ...
            var that = this,
                ...
                dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                    ...
                    dataSource2.fetch(function() {
                        ...
                        itemData.set('signature', $("#signatureRWSC").jSignature("getData"));
    ...
    if (typeof dataProvider.sbProviderReady === 'function') {
        dataProvider.sbProviderReady(function dl_sbProviderReady() {
            parent.set('returnWire2AndSupportAndConnection2Model', returnWire2AndSupportAndConnection2Model);
            var param = parent.get('returnWire2AndSupportAndConnection2Model_delayedFetch');
            if (typeof param !== 'undefined') {
                parent.set('returnWire2AndSupportAndConnection2Model_delayedFetch', undefined);
    ...
    parent.set('onShow', function(e) {
        var param = e.view.params.filter ? JSON.parse(e.view.params.filter) : null,
            ...
            dataSourceOptions = returnWire2AndSupportAndConnection2Model.get('_dataSourceOptions'),
            dataSource;
        ...
        if (!returnWire2AndSupportAndConnection2Model.get('dataSource')) {
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                var jsdoOptions = returnWire2AndSupportAndConnection2Model.get('_jsdoOptions'),
                    jsdo = new progress.data.JSDO(jsdoOptions);

                dataSourceOptions.transport.jsdo = jsdo;
                dataSource = new kendo.data.DataSource(dataSourceOptions);
                returnWire2AndSupportAndConnection2Model.set('dataSource', dataSource);
...
})(app.returnWire2AndSupportAndConnection2);

// START_CUSTOM_CODE_returnWire2AndSupportAndConnection2Model
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// you can handle the beforeFill / afterFill events here. For example:
/*
app.returnWire2AndSupportAndConnection2.returnWire2AndSupportAndConnection2Model.get('_jsdoOptions').events = {
    'beforeFill' : [ {
        scope : app.returnWire2AndSupportAndConnection2.returnWire2AndSupportAndConnection2Model,
...
*/
// END_CUSTOM_CODE_returnWire2AndSupportAndConnection2Model