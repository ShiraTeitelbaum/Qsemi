...
(function(parent) {
    var dataProvider = app.data.qcsemidataProvider,
        ...
        setupMapView = function(container) {
            if (!mapViewModel.map) {
                ...
                var tileLayer = L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}', {
                    ...
                    id: 'mapbox.streets',
                    accessToken: 'pk.eyJ1Ijoibm9hcyIsImEiOiJjajdxYjZwYnIzcWd4MnFtanE2bnlkZmo4In0.mcFH1c8-iJOqRI3EmoQzag'
                });
        ...
        mapViewModel = kendo.observable({
            ...
            setCurrentItemByUid: function(uid) {
                ...
                if (!itemModel.KP) {
                    itemModel.KP = String.fromCharCode(160);
                }
    ...
    parent.set('onShow', function(e) {
        ...
        if (!mapViewModel.get('dataSource')) {
