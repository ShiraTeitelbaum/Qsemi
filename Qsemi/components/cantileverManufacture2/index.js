...
app.cantileverManufacture2 = kendo.observable({
    onShow: function() {},
    afterShow: function() {}
});
app.localization.registerView('cantileverManufacture2');

// START_CUSTOM_CODE_cantileverManufacture2
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_cantileverManufacture2
(function(parent) {
    var dataProvider = app.data.qcsemidataProvider,
        ...
        fetchFilteredData = function(paramFilter, searchFilter) {
            var model = parent.get('cantileverManufacture2Model'),
                dataSource;

            if (model) {
                dataSource = model.get('dataSource');
            } else {
                parent.set('cantileverManufacture2Model_delayedFetch', paramFilter || null);
                return;
            }
        ...
        /// start data sources
        /// end data sources
        cantileverManufacture2Model = kendo.observable({
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || cantileverManufacture2Model.originalItem;

                app.mobileApp.navigate('#components/cantileverManufacture2/details.html?uid=' + dataItem.uid);

            },
            editClick: function() {
                var uid = this.originalItem.uid;
                app.mobileApp.navigate('#components/cantileverManufacture2/edit.html?uid=' + uid);
            },
            detailsShow: function(e) {
                var uid = e.view.params.uid,
                    dataSource = cantileverManufacture2Model.get('dataSource'),
                    itemModel = dataSource.getByUid(uid);

                cantileverManufacture2Model.setCurrentItemByUid(uid);
            ...
            setCurrentItemByUid: function(uid) {
                ...
                cantileverManufacture2Model.set('originalItem', itemModel);
                cantileverManufacture2Model.set('currentItem',
                    cantileverManufacture2Model.fixHierarchicalData(itemModel));
    ...
    parent.set('editItemViewModel', kendo.observable({
        ...
        onShow: function(e) {
            ...
            var that = this,
                ...
                //fixedData = cantileverManufacture2Model.fixHierarchicalData(itemData);

                app.mobileApp.showLoading();
            /// start edit form before itemData
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                 var jsdoOptions2 = cantileverManufacture2Model.get('_jsdoOptions'),
                ...
                dataSource2.filter({ field: "R363889658", operator: "==", value: element_id });
                ...
                dataSource2.fetch(function() {
                    ...
                    fixedData = cantileverManufacture2Model.fixHierarchicalData(itemData);
                     ...
                     var checkBox1List = app.cantileverManufacture2.cantileverManufacture2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox1().response.picklistData;
                     var checkBox2List = app.cantileverManufacture2.cantileverManufacture2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox2().response.picklistData;
                     var checkBox3List = app.cantileverManufacture2.cantileverManufacture2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox3().response.picklistData;
                     var checkBox4List = app.cantileverManufacture2.cantileverManufacture2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox4().response.picklistData;
                     var checkBox5List = app.cantileverManufacture2.cantileverManufacture2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox5().response.picklistData;
                     ...
                     if(itemData.Checkbox1 != "null") {
                        for(var i=0; i<checkBox1List.length; i++) {
                            if(itemData.Checkbox1 == checkBox1List[i].id && checkBox1List[i].name == "OK") {
                                $("#checkbox1CM").attr("checked", true);
                            }
                            else if(itemData.Checkbox1 == checkBox1List[i].id && checkBox1List[i].name == "Not OK") {
                                $("#checkbox1NotOkCM").attr("checked", true);
                                $("#comments1FieldCM").show();
                            }
                        }
                     }
                     if(itemData.Checkbox2 != "null") {
                        for(var i=0; i<checkBox2List.length; i++) {
                            if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "OK") {
                                $("#checkbox2CM").attr("checked", true);
                            }
                            else if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "Not OK") {
                                $("#checkbox2NotOkCM").attr("checked", true);
                                $("#comments2FieldCM").show();
                            }
                        }
                     }
                     if(itemData.Checkbox3 != "null") {
                        for(var i=0; i<checkBox3List.length; i++) {
                            if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "OK") {
                                $("#checkbox3CM").attr("checked", true);
                            }
                            else if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "Not OK") {
                                $("#checkbox3NotOkCM").attr("checked", true);
                                $("#comments3FieldCM").show();
                            }
                        }
                     }
                     if(itemData.Checkbox4 != "null") {
                        for(var i=0; i<checkBox4List.length; i++) {
                            if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "OK") {
                                $("#checkbox4CM").attr("checked", true);
                            }
                            else if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "Not OK") {
                                $("#checkbox4NotOkCM").attr("checked", true);
                                $("#comments4FieldCM").show();
                            }
                        }
                     }
                     if(itemData.Checkbox5 != "null") {
                        for(var i=0; i<checkBox5List.length; i++) {
                            if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "OK") {
                                $("#checkbox5CM").attr("checked", true);
                            }
                            else if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "Not OK") {
                                $("#checkbox5NotOkCM").attr("checked", true);
                                $("#comments5FieldCM").show();
                            }
                        }
                     }

                     if(itemData.Completed == true) {
                         $("#completedCM").attr("checked", true);
                     }
            ...
            $("#comments1FieldCM").hide();
            $("#comments2FieldCM").hide();
            $("#comments3FieldCM").hide();
            $("#comments4FieldCM").hide();
            $("#comments5FieldCM").hide();
            /// end edit form show
        },
        linkBind: function(linkString) {
            var linkChunks = linkString.split(':');
            ...
            var that = this,
                ...
                dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                    ...
                    dataSource2.fetch(function() {
                        ...
                        itemData.set('signature', $("#signatureCM").jSignature("getData"));
    ...
    if (typeof dataProvider.sbProviderReady === 'function') {
        dataProvider.sbProviderReady(function dl_sbProviderReady() {
            parent.set('cantileverManufacture2Model', cantileverManufacture2Model);
            var param = parent.get('cantileverManufacture2Model_delayedFetch');
            if (typeof param !== 'undefined') {
                parent.set('cantileverManufacture2Model_delayedFetch', undefined);
    ...
    parent.set('onShow', function(e) {
        var param = e.view.params.filter ? JSON.parse(e.view.params.filter) : null,
            ...
            dataSourceOptions = cantileverManufacture2Model.get('_dataSourceOptions'),
            dataSource;
        ...
        if (!cantileverManufacture2Model.get('dataSource')) {
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                var jsdoOptions = cantileverManufacture2Model.get('_jsdoOptions'),
                    jsdo = new progress.data.JSDO(jsdoOptions);

                dataSourceOptions.transport.jsdo = jsdo;
                dataSource = new kendo.data.DataSource(dataSourceOptions);
                cantileverManufacture2Model.set('dataSource', dataSource);
...
})(app.cantileverManufacture2);

// START_CUSTOM_CODE_cantileverManufacture2Model
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// you can handle the beforeFill / afterFill events here. For example:
/*
app.cantileverManufacture2.cantileverManufacture2Model.get('_jsdoOptions').events = {
    'beforeFill' : [ {
        scope : app.cantileverManufacture2.cantileverManufacture2Model,
...
*/
// END_CUSTOM_CODE_cantileverManufacture2Model