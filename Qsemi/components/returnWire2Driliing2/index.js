...
app.returnWire2Driliing2 = kendo.observable({
    onShow: function() {},
    afterShow: function() {}
});
app.localization.registerView('returnWire2Driliing2');

// START_CUSTOM_CODE_returnWire2Driliing2
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_returnWire2Driliing2
(function(parent) {
    var dataProvider = app.data.qcsemidataProvider,
        ...
        fetchFilteredData = function(paramFilter, searchFilter) {
            var model = parent.get('returnWire2Driliing2Model'),
                dataSource;

            if (model) {
                dataSource = model.get('dataSource');
            } else {
                parent.set('returnWire2Driliing2Model_delayedFetch', paramFilter || null);
                return;
            }
        ...
        /// start data sources
        /// end data sources
        returnWire2Driliing2Model = kendo.observable({
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || returnWire2Driliing2Model.originalItem;

                app.mobileApp.navigate('#components/returnWire2Driliing2/details.html?uid=' + dataItem.uid);

            },
            editClick: function() {
                var uid = this.originalItem.uid;
                app.mobileApp.navigate('#components/returnWire2Driliing2/edit.html?uid=' + uid);
            },
            detailsShow: function(e) {
                var uid = e.view.params.uid,
                    dataSource = returnWire2Driliing2Model.get('dataSource'),
                    itemModel = dataSource.getByUid(uid);

                returnWire2Driliing2Model.setCurrentItemByUid(uid);
            ...
            setCurrentItemByUid: function(uid) {
                ...
                returnWire2Driliing2Model.set('originalItem', itemModel);
                returnWire2Driliing2Model.set('currentItem',
                    returnWire2Driliing2Model.fixHierarchicalData(itemModel));
    ...
    parent.set('editItemViewModel', kendo.observable({
        ...
        onShow: function(e) {
            ...
            var that = this,
                ...
                //fixedData = returnWire2Driliing2Model.fixHierarchicalData(itemData);

                app.mobileApp.showLoading();
            /// start edit form before itemData
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                var jsdoOptions2 = returnWire2Driliing2Model.get('_jsdoOptions'),
                ...
                dataSource2.filter({ field: "R363890842", operator: "==", value: element_id });
                ...
                dataSource2.fetch(function() {
                    ...
                    fixedData = returnWire2Driliing2Model.fixHierarchicalData(itemData);
                     ...
                     var checkBox1List = app.returnWire2Driliing2.returnWire2Driliing2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox1().response.picklistData;
                     var checkBox2List = app.returnWire2Driliing2.returnWire2Driliing2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox2().response.picklistData;
                     var checkBox3List = app.returnWire2Driliing2.returnWire2Driliing2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox3().response.picklistData;
                     var checkBox4List = app.returnWire2Driliing2.returnWire2Driliing2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox4().response.picklistData;
                     var checkBox5List = app.returnWire2Driliing2.returnWire2Driliing2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox5().response.picklistData;
                     ...
                     if(itemData.Checkbox1 != "null") {
                        for(var i=0; i<checkBox1List.length; i++) {
                            if(itemData.Checkbox1 == checkBox1List[i].id && checkBox1List[i].name == "OK") {
                                $("#checkbox1RWD").attr("checked", true);
                            }
                            else if(itemData.Checkbox1 == checkBox1List[i].id && checkBox1List[i].name == "Not OK") {
                                $("#checkbox1NotOkRWD").attr("checked", true);
                                $("#comments1FieldRWD").show();
                            }
                        }
                     }
                     if(itemData.Checkbox2 != "null") {
                        for(var i=0; i<checkBox2List.length; i++) {
                            if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "OK") {
                                $("#checkbox2RWD").attr("checked", true);
                            }
                            else if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "Not OK") {
                                $("#checkbox2NotOkRWD").attr("checked", true);
                                $("#comments2FieldRWD").show();
                            }
                        }
                     }
                     if(itemData.Checkbox3 != "null") {
                        for(var i=0; i<checkBox3List.length; i++) {
                            if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "OK") {
                                $("#checkbox3RWD").attr("checked", true);
                            }
                            else if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "Not OK") {
                                $("#checkbox3NotOkRWD").attr("checked", true);
                                $("#comments3FieldRWD").show();
                            }
                        }
                     }
                     if(itemData.Checkbox4 != "null") {
                        for(var i=0; i<checkBox4List.length; i++) {
                            if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "OK") {
                                $("#checkbox4RWD").attr("checked", true);
                            }
                            else if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "Not OK") {
                                $("#checkbox4NotOkRWD").attr("checked", true);
                                $("#comments4FieldRWD").show();
                            }
                        }
                     }
                     if(itemData.Checkbox5 != "null") {
                        for(var i=0; i<checkBox5List.length; i++) {
                            if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "OK") {
                                $("#checkbox5RWD").attr("checked", true);
                            }
                            else if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "Not OK") {
                                $("#checkbox5NotOkRWD").attr("checked", true);
                                $("#comments5FieldRWD").show();
                            }
                        }
                     }

                     if(itemData.Completed == true) {
                         $("#completedRWD").attr("checked", true);
                     }
            ...
            $("#comments1FieldRWD").hide();
            $("#comments2FieldRWD").hide();
            $("#comments3FieldRWD").hide();
            $("#comments4FieldRWD").hide();
            $("#comments5FieldRWD").hide();
            /// end edit form show
        },
        linkBind: function(linkString) {
            var linkChunks = linkString.split(':');
            ...
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                ...
                dataSource2.fetch(function() {
                    ...
                    for(var i=0; i<checkBox1List.length; i++) {
                        ...
                        itemData.set('signature', $("#signatureRWD").jSignature("getData"));
    ...
    if (typeof dataProvider.sbProviderReady === 'function') {
        dataProvider.sbProviderReady(function dl_sbProviderReady() {
            parent.set('returnWire2Driliing2Model', returnWire2Driliing2Model);
            var param = parent.get('returnWire2Driliing2Model_delayedFetch');
            if (typeof param !== 'undefined') {
                parent.set('returnWire2Driliing2Model_delayedFetch', undefined);
    ...
    parent.set('onShow', function(e) {
        var param = e.view.params.filter ? JSON.parse(e.view.params.filter) : null,
            ...
            dataSourceOptions = returnWire2Driliing2Model.get('_dataSourceOptions'),
            dataSource;
        ...
        if (!returnWire2Driliing2Model.get('dataSource')) {
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                var jsdoOptions = returnWire2Driliing2Model.get('_jsdoOptions'),
                    jsdo = new progress.data.JSDO(jsdoOptions);

                dataSourceOptions.transport.jsdo = jsdo;
                dataSource = new kendo.data.DataSource(dataSourceOptions);
                returnWire2Driliing2Model.set('dataSource', dataSource);
...
})(app.returnWire2Driliing2);

// START_CUSTOM_CODE_returnWire2Driliing2Model
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// you can handle the beforeFill / afterFill events here. For example:
/*
app.returnWire2Driliing2.returnWire2Driliing2Model.get('_jsdoOptions').events = {
    'beforeFill' : [ {
        scope : app.returnWire2Driliing2.returnWire2Driliing2Model,
...
*/
// END_CUSTOM_CODE_returnWire2Driliing2Model