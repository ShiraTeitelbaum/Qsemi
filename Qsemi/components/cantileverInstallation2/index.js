...
app.cantileverInstallation2 = kendo.observable({
    onShow: function() {},
    afterShow: function() {}
});
app.localization.registerView('cantileverInstallation2');

// START_CUSTOM_CODE_cantileverInstallation2
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_cantileverInstallation2
(function(parent) {
    var dataProvider = app.data.qcsemidataProvider,
        ...
        fetchFilteredData = function(paramFilter, searchFilter) {
            var model = parent.get('cantileverInstallation2Model'),
                dataSource;

            if (model) {
                dataSource = model.get('dataSource');
            } else {
                parent.set('cantileverInstallation2Model_delayedFetch', paramFilter || null);
                return;
            }
        ...
        /// start data sources
        /// end data sources
        cantileverInstallation2Model = kendo.observable({
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || cantileverInstallation2Model.originalItem;

                app.mobileApp.navigate('#components/cantileverInstallation2/details.html?uid=' + dataItem.uid);

            },
            editClick: function() {
                var uid = this.originalItem.uid;
                app.mobileApp.navigate('#components/cantileverInstallation2/edit.html?uid=' + uid);
            },
            detailsShow: function(e) {
                var uid = e.view.params.uid,
                    dataSource = cantileverInstallation2Model.get('dataSource'),
                    itemModel = dataSource.getByUid(uid);

                cantileverInstallation2Model.setCurrentItemByUid(uid);
            ...
            setCurrentItemByUid: function(uid) {
                ...
                cantileverInstallation2Model.set('originalItem', itemModel);
                cantileverInstallation2Model.set('currentItem',
                    cantileverInstallation2Model.fixHierarchicalData(itemModel));
    ...
    parent.set('editItemViewModel', kendo.observable({
        ...
        onShow: function(e) {
            ...
            var that = this,
                ...
                //fixedData = cantileverInstallation2Model.fixHierarchicalData(itemData);

                app.mobileApp.showLoading();
            /// start edit form before itemData
                 dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                     var jsdoOptions2 = cantileverInstallation2Model.get('_jsdoOptions'),
                    ...
                    dataSource2.filter({ field: "R363889627", operator: "==", value: element_id });
                    ...
                    dataSource2.fetch(function() {
                        ...
                        var checkBox1List = app.cantileverInstallation2.cantileverInstallation2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox1().response.picklistData;
                        var checkBox2List = app.cantileverInstallation2.cantileverInstallation2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox2().response.picklistData;
                        var checkBox3List = app.cantileverInstallation2.cantileverInstallation2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox3().response.picklistData;
                        var checkBox4List = app.cantileverInstallation2.cantileverInstallation2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox4().response.picklistData;
                        var checkBox5List = app.cantileverInstallation2.cantileverInstallation2Model._dataSourceOptions.transport.jsdo.getPicklist_Checkbox5().response.picklistData;
                        ...
                        if(itemData.Checkbox1 != "null") {
                            for(var i=0; i<checkBox1List.length; i++) {
                                if(itemData.Checkbox1 == checkBox1List[i].id && checkBox1List[i].name == "OK") {
                                    $("#checkbox1CI").attr("checked", true);
                                }
                                else if(itemData.Checkbox1 == checkBox1List[i].id && checkBox1List[i].name == "Not OK") {
                                    $("#checkbox1NotOkCI").attr("checked", true);
                                    $("#comments1FieldCI").show();
                                }
                            }
                        }
                        if(itemData.Checkbox2 != "null") {
                            for(var i=0; i<checkBox2List.length; i++) {
                                if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "OK") {
                                    $("#checkbox2CI").attr("checked", true);
                                }
                                else if(itemData.Checkbox2 == checkBox2List[i].id && checkBox2List[i].name == "Not OK") {
                                    $("#checkbox2NotOkCI").attr("checked", true);
                                    $("#comments2FieldCI").show();
                                }
                            }
                        }
                        if(itemData.Checkbox3 != "null") {
                            for(var i=0; i<checkBox3List.length; i++) {
                                if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "OK") {
                                    $("#checkbox3CI").attr("checked", true);
                                }
                                else if(itemData.Checkbox3 == checkBox3List[i].id && checkBox3List[i].name == "Not OK") {
                                    $("#checkbox3NotOkCI").attr("checked", true);
                                    $("#comments3FieldCI").show();
                                }
                            }
                        }
                        if(itemData.Checkbox4 != "null") {
                            for(var i=0; i<checkBox4List.length; i++) {
                                if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "OK") {
                                    $("#checkbox4CI").attr("checked", true);
                                }
                                else if(itemData.Checkbox4 == checkBox4List[i].id && checkBox4List[i].name == "Not OK") {
                                    $("#checkbox4NotOkCI").attr("checked", true);
                                    $("#comments4FieldCI").show();
                                }
                            }
                        }
                        if(itemData.Checkbox5 != "null") {
                            for(var i=0; i<checkBox5List.length; i++) {
                                if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "OK") {
                                    $("#checkboxCI").attr("checked", true);
                                }
                                else if(itemData.Checkbox5 == checkBox5List[i].id && checkBox5List[i].name == "Not OK") {
                                    $("#checkbox5NotOkCI").attr("checked", true);
                                    $("#comments5FieldCI").show();
                                }
                            }
                        }

                        if(itemData.Completed == true) {
                            $("#completedCI").attr("checked", true);
                        }
            ...
            $("#comments1FieldCI").hide();
            $("#comments2FieldCI").hide();
            $("#comments3FieldCI").hide();
            $("#comments4FieldCI").hide();
            $("#comments5FieldCI").hide();
            /// end edit form show
        },
        linkBind: function(linkString) {
            var linkChunks = linkString.split(':');
            ...
            var that = this,
                ...
                dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                    ...
                    dataSource2.fetch(function() {
                        ...
                        itemData.set('signature', $("#signatureCI").jSignature("getData"));
    ...
    if (typeof dataProvider.sbProviderReady === 'function') {
        dataProvider.sbProviderReady(function dl_sbProviderReady() {
            parent.set('cantileverInstallation2Model', cantileverInstallation2Model);
            var param = parent.get('cantileverInstallation2Model_delayedFetch');
            if (typeof param !== 'undefined') {
                parent.set('cantileverInstallation2Model_delayedFetch', undefined);
    ...
    parent.set('onShow', function(e) {
        var param = e.view.params.filter ? JSON.parse(e.view.params.filter) : null,
            ...
            dataSourceOptions = cantileverInstallation2Model.get('_dataSourceOptions'),
            dataSource;
        ...
        if (!cantileverInstallation2Model.get('dataSource')) {
            dataProvider.loadCatalogs().then(function _catalogsLoaded() {
                var jsdoOptions = cantileverInstallation2Model.get('_jsdoOptions'),
                    jsdo = new progress.data.JSDO(jsdoOptions);

                dataSourceOptions.transport.jsdo = jsdo;
                dataSource = new kendo.data.DataSource(dataSourceOptions);
                cantileverInstallation2Model.set('dataSource', dataSource);
...
})(app.cantileverInstallation2);

// START_CUSTOM_CODE_cantileverInstallation2Model
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// you can handle the beforeFill / afterFill events here. For example:
/*
app.cantileverInstallation2.cantileverInstallation2Model.get('_jsdoOptions').events = {
    'beforeFill' : [ {
        scope : app.cantileverInstallation2.cantileverInstallation2Model,
...
*/
// END_CUSTOM_CODE_cantileverInstallation2Model